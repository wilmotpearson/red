...

{
    ...
    {        $badType = false;
        ...
        switch ( $pType )        {
            ...
            default:                throw new SanitizerException ( S_ERRMSG_UNKNOWN_PHP_TYPE, S_ERRNUM_UNKNOWN_PHP_TYPE );

        }



        if ( $badType )            throw new SanitizerException ( S_ERRMSG_INVALID_TYPE, S_ERRNUM_INVALID_TYPE );
...

    {
        ...
        if ( !isset ( $pParameter ) )            throw new SanitizerException ( S_ERRMSG_MISSING_PARAMETER, S_ERRNUM_MISSING_PARAMETER );
